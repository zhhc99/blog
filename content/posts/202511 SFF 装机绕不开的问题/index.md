...
很多人喜欢 SFF (Small Form Factor) PC, 它就像西装暴徒一样令人爱不释手, 但对装机的要求是最高的. 很多人装完以后发现, 性能不够用, 风扇特别吵, 各种不满意.

这里不推荐配置单, 而是聊几个在下单前必须想明白的问题.

## 结构比体积更重要

圈子里喜欢比体积, 但真正决定散热的是结构: 风道怎么走, 热量往哪排. 想用得轻松, 得先确保机箱的结构合理.

这里有些 7L 以下的, 结构还算合理的机箱样例. 现在同类竞品都不少, 因此不一定要买图中的款式. 后面我们会在配置上尽可能兜住各种需求, 所以可以尽情挑选喜欢的机箱.

> SFF 的热密度往往爆炸, 这是任何设计都无法逃避的物理定律, 除非打开侧板或裸露一些元件在外面. 需要提醒: 裸露风扇极大增加物体和液体卷入的风险.

### 经典直插

![LZMod A24v5](lzmod-a24-v5.webp)

LP 显卡直插主板, 机箱顶部直接出风, Flex PSU 侧置. 最简单也科学的风道.

对 CPU 散热极其友好. 需要电源转接线.
...
稍微委屈了 CPU, 也稍微便宜了显卡. 最好像图中那样, 有前侧的出风风道.
...
- 各种**平铺机箱**. 比较扁, 携带有优势, 但...沉, 而且我觉得不好看. 至于主打的散热, 冷暖自知, 不做评价.
...
- 90mm 塔体可以换 120mm 风扇, 略微辛苦 CPU, 换来对内存的照顾.

还有个事: 散热器高度不要太极限, 进气扇贴近侧板孔洞时会产生湍流 (风切), 会扰乱气流, 而且那声音很难听.

## 调教你的设备

机箱和 CPU 选定后, 做一点点一次性的配置, 可以让机器不浪费性能, 运转更顺畅.
